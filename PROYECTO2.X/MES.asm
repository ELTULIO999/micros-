...
RETURN 
 ...
 MOVLW .1                       ;CAMBIO DE MES_L
 MOVWF CONTMES_L
CALL MES_L
 MOVWF TEMPMES_L
 ANDLW B'00001111';
 MOVWF NIBBLE_ML                 ;CAMBIO DE MES_H
 MOVLW .0
 MOVWF CONTMES_H
CALL MES_H
 MOVWF TEMPMES_H
